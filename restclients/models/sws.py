...
class Term(RestClientsModel):
    ...
    aterm_last_date = models.DateField(null=True, blank=True)
    bterm_first_date = models.DateField(null=True, blank=True)
    aterm_last_day_add = models.DateField(null=True, blank=True)
    bterm_last_day_add = models.DateField(null=True, blank=True)
    last_final_exam_date = models.DateField()
    grading_period_open = models.DateTimeField()
    aterm_grading_period_open = models.DateTimeField(null=True, blank=True)
    grading_period_close = models.DateTimeField()
    grade_submission_deadline = models.DateTimeField()
    registration_services_start = models.DateTimeField(null=True, blank=True)
    registration_period1_start = models.DateTimeField(null=True, blank=True)
    registration_period1_end = models.DateTimeField(null=True, blank=True)
    registration_period2_start = models.DateTimeField(null=True, blank=True)
    registration_period2_end = models.DateTimeField(null=True, blank=True)
    registration_period3_start = models.DateTimeField(null=True, blank=True)
    registration_period3_end = models.DateTimeField(null=True, blank=True)
...
class NoticeAttribute(RestClientsModel):
    ...
    _date_value = models.DateField(null=True, blank=True)
